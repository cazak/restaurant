...
#[Route('/reports/top/quantity/daily', methods: ['GET'])]
#[AsController]
final class DailyTopByQuantity
{
    ...
    {
        return new JsonResponse($this->topDishesInPeriodByQuantity->daily(), Response::HTTP_OK);
    }
}
