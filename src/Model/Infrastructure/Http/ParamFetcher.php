...
namespace App\Model\Infrastructure\Http;

use App\Model\Infrastructure\Assert;
use App\Model\Infrastructure\Type\DateTimeFormat;
use DateTimeImmutable;
use Symfony\Component\HttpFoundation\Request;

/**
 * Taken from https://github.com/ferrius/ddd-cqrs-example/blob/master/src/Shared/Infrastructure/Http/ParamFetcher.php.
 */
final class ParamFetcher
{
    ...
    private const SCALAR_TYPES = [self::TYPE_STRING, self::TYPE_INT, self::TYPE_FLOAT];
